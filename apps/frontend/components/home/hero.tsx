	...
	return (
		<BackgroundContainer>
			<div className="relative mb-4 h-[30vh] w-full ">
				...
				<h1 className="text-center text-7xl sm:text-8xl font-semibold bg-clip-text text-transparent bg-[linear-gradient(to_right,theme(colors.purple.500),theme(colors.pink.400),theme(colors.violet.600),theme(colors.blue.300),theme(colors.purple.400),theme(colors.pink.300),theme(colors.purple.500))] bg-[length:200%_auto] animate-[gradient_8s_linear_infinite]">
					🎯 Offer 捕手
				</h1>
			</div>
			<p className="mb-12 --font-space-grotesk text-center text-lg bg-gradient-to-br from-pink-400 via-purple-400 to-violet-600 bg-clip-text text-transparent md:text-xl">
